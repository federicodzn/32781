...
Una vez elegido el input a evalaur, guardar (control + s).
 Hacer este mismo procedimiento en launch.json (se encuentra dentro de la carpeta .vscode) en la línea 8 ("input": "input_correcto1.txt",), elegir el input a evaluar y guardar.
